...
?>
        ...
        <div class="footer-content">
            <div class="footer-grid">
                <div class="footer-section">
                    <h3>Almas Clothing</h3>
                    <p class="footer-about">Experience luxury fashion with our curated collection of contemporary clothing and accessories.</p>
                ...
                <div class="footer-section">
                    <h3>Categories</h3>
                    <ul class="footer-links">
                        <li><a href="/almas_clothing/public/shop.php?category=1">Women's Fashion</a></li>
                        <li><a href="/almas_clothing/public/shop.php?category=2">Men's Fashion</a></li>
                        <li><a href="/almas_clothing/public/shop.php?category=3">Accessories</a></li>
                        <li><a href="/almas_clothing/public/shop.php?category=4">New Arrivals</a></li>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                <div class="copyright">&copy; 2025 Almas Clothing Brand. All Rights Reserved.</div>
    ...
    <script src="/almas_clothing/public/scripts/ui.js"></script>
</body>
</html>
